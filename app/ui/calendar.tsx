...
const CalendarHeaderItem = ({ text, className = '' }: CalendarItemProps) => {
  return (
    <div className='flex aspect-square items-center justify-center border-b border-[#586948]'>
      <p
        className={clsx(
          'inter text-center text-lg text-[#586948] md:text-2xl',
          className,
        )}
      >
        {text}
...
const CalendarItem = ({ text, className = '' }: CalendarItemProps) => {
  return (
    <div className='flex aspect-square items-center justify-center'>
      <p
        className={clsx(
          'sacramento text-center text-lg text-[#586948] md:text-2xl',
          className,
        )}
      >
        {text}
...
const Calendar = () => {
  return (
    <div className='flex w-screen flex-col items-center justify-center py-4'>
      <div>
        <p className='sacramento text-4xl text-[#586948] md:text-6xl'>
          Tháng 9
        </p>
      </div>
